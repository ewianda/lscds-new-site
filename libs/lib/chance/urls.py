...
urlpatterns = patterns('',
    url(r'^list/$', generic.list.ListView.as_view(model=models.Event), name='event_list'),
    url(r'^(?P<pk>\d+)/$', generic.detail.DetailView.as_view(model=models.Event),
        name='event'),
    url(r'^(?P<event>\d+)/register/$', views.CreateRegistrationView.as_view(),
        name='event_registration'),
    url(r'^(?P<event>\d+)/register/(?P<pk>\d+)/$', views.RegistrationDetailView.as_view(),        name='registration'),
