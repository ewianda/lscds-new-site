...
import warnings
"""
There is a lot of redundant imports here, but who cares!!!!!
"""
...
class NetWorkForm(forms.Form):
     ...
     def clean_round_table_2(self):
        ...
        if not round_table_2.registration_open and rt.count()==0:
     ...
     def clean_round_table_1(self):
        ...
        if not round_table_1.registration_open and rt.count()==0:
            raise forms.ValidationError("This table is full")        
